...
Unlike my blog rebuild you _probably_ have noticed this new framework taking the JS world by storm: [Gatsby JS](https://www.gatsbyjs.org). In case you haven't, the short summary is that it's a static site generator, powered by [GraphQL](https://graphql.org) and [React](https://reactjs.org) (colloquially known as a web developer's wet dream).
...
So Gatsby takes all of that, and makes it stupidly simple to get a react based site up and running. Plus, it includes server side rendering and static generation out of the box - you don't have to do anything to get it. On top of that, because it's built on GraphQL, you can finally have the motivation to learn _yet another_ JS framework. Trust me, it's worth it, GraphQL is awesome.
